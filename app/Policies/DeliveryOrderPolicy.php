...
class DeliveryOrderPolicy
{
    ...
    {
        return $user->can('view_any_delivery_order');
    }
    ...
    {
        return $user->can('update_delivery_order');
    }
    ...
    {
        return $user->can('delete_delivery_order');
    }
    ...
    {
        return $user->can('delete_any_delivery_order');
    }
    ...
    {
        return $user->can('force_delete_delivery_order');
    }
    ...
    {
        return $user->can('force_delete_any_delivery_order');
    }
    ...
    {
        return $user->can('restore_delivery_order');
    }
    ...
    {
        return $user->can('restore_any_delivery_order');
    }
    ...
    {
        return $user->can('replicate_delivery_order');
    }
    ...
    {
        return $user->can('reorder_delivery_order');
    }
}
