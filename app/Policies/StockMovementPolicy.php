...
class StockMovementPolicy
{
    ...
    {
        return $user->can('delete_any_stock_movement');
    }
    ...
    {
        return $user->can('force_delete_any_stock_movement');
    }
    ...
    {
        return $user->can('restore_any_stock_movement');
    }
    ...
    {
        return $user->can('replicate_stock_movement');
    }
    ...
    {
        return $user->can('reorder_stock_movement');
    }
}
